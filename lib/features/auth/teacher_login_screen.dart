...
class _TeacherLoginScreenState extends State<TeacherLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (e.code == 'teacher-not-found') {
        errorMessage = 'Teacher email not found';
      } else if (e.code == 'user-not-found') {
        errorMessage = 'Teacher account not found';
      } else if (e.code == 'wrong-password') {
        errorMessage = 'Incorrect teacher ID';
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      'Enter your email and teacher ID',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Use your teacher ID as password',
                              style: TextStyle(
                                fontSize: 14,
